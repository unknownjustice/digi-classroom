...
import com.example.myapplication.StrokeManager.DownloadedModelsChangedListener;
...
public class DigitalInkMainActivity extends AppCompatActivity implements DownloadedModelsChangedListener {
    ...
    private static final ImmutableMap<String, String> NON_TEXT_MODELS =
            ImmutableMap.of(
                    ...
                    "zxx-Zsym-x-shapes",
                    "Shapes");
    @VisibleForTesting final com.example.myapplication.StrokeManager strokeManager = new com.example.myapplication.StrokeManager();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        strokeManager.setStatusChangedListener((StrokeManager.StatusChangedListener) statusTextView);
        strokeManager.setContentChangedListener((StrokeManager.ContentChangedListener) drawingView);
    ...
    public void clearClick(View v) {
        strokeManager.reset();
        com.example.myapplication.DrawingView drawingView = findViewById(R.id.drawing_view);
        drawingView.clear();
    }
